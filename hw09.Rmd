---
title: "STATS 810 Fall 2021, Homework 9. <br>Internet repositories for collaboration and open-source research: git and GitHub"
output:
  html_document:
    theme: flatly
    toc: no
...
* Our tasks are 
    ...
    iv. Report briefly on your past experience with git, and what you learned while studying for this homework. Edit the `hw09.Rmd` file in the `810f21` git repository, compile this to html (for example, using Rstudio) and submit your report via Canvas as an html file.

Answer:

I have been using github to do version control on my previous project. But my grasp on shell commands is very limited. I haven't yet setup git account on my new laptop, so this is a good opportunity to do that.
...
## A workflow to contribute to the 810f21 GitHub repository

* If you tell me your GitHub username, I could in principle add you as a developer of the `ionides/810f21` GitHub repository. Then you can commit changes directly.
...
1. Go to `ionides/810f21` on GitHub, for example by searching for `810f21`.

2. Click `fork` at the top right-hand corner, and follow instructions to add a forked copy to your own GitHub account. It should now show up in your account as `my_username/810f21`.

3. Clone a local copy of the forked repository to your machine, e.g.,

```
git clone https://github.com/my_username/810f21.git
```

4. Move to the `810f21` directory and edit the file `sign_here.html` to check your own name.
...
5. Commit this change to your local version of the forked `810f21`,
...
6. Push this change to your forked copy of `810f21` on GitHub:

```
git push
```

7. On the GitHub web site for the `my_username/810f21` fork, click `New pull request` and follow instructions. When you have successfully placed your pull request, the owner of the parent repository (me) will be notifed. I will then pull the modifications from your fork into `ionides/810f21`.
